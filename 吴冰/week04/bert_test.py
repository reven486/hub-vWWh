...
# 加载和预处理数据
dataset_df = pd.read_excel("./product01.xlsx", header=None)

# dataset_df =  MsDataset.load('winwin_inc/product-classification-hiring-demo', subset_name='default', split='test')
